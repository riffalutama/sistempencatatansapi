...
const {ROLE_peternak, ROLE_ADMIN, ROLE_PATIENT, CHANGE_TMP_PASSWORD} = require('../utils');
...
app.post('/login', async (req, res) => {
  ...
  if (role === ROLE_peternak || role === ROLE_ADMIN) {
...
// //////////////////////////////// Admin Routes //////////////////////////////////////
app.post('/peternak/register', authenticateJWT, adminRoutes.createpeternak);
...
// //////////////////////////////// peternak Routes //////////////////////////////////////
app.patch('/patients/:patientId/details/medical', authenticateJWT, peternakRoutes.updatePatientMedicalDetails);
app.get('/peternak/:hospitalId([0-9]+)/:peternakId(HOSP[0-9]+\-DOC[0-9]+)', authenticateJWT, peternakRoutes.getpeternakById);
...
app.get('/peternak/:hospitalId([0-9]+)/_all', authenticateJWT, patientRoutes.getpeternaksByHospitalId);
app.patch('/patients/:patientId/grant/:peternakId', authenticateJWT, patientRoutes.grantAccessTopeternak);
app.patch('/patients/:patientId/revoke/:peternakId', authenticateJWT, patientRoutes.revokeAccessFrompeternak);
