...
export class PatientService {
  ...
  public grantAccessTopeternak(patientId: string, peternakId: string): Observable<any> {
    return this.http.patch(this.patientURL + `/${patientId}/grant/${peternakId}`, {});
  }

  public revokeAccessFrompeternak(patientId: string, peternakId: string): Observable<any> {
    return this.http.patch(this.patientURL + `/${patientId}/revoke/${peternakId}`, {});
  }
}
